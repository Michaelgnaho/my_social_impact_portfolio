        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <blockquote className="text-2xl md:text-3xl font-semibold italic">
              Real change happens when voices from the margins are centered and
              supported.
            </blockquote>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div className="space-y-4">
              ...
              <p className="text-slate-600 leading-relaxed">
                ...
                Janitor Initiative where people can learn about their work, get
                motivated to join them, and make donations toward their cause.
                This project represents another dimension of climate
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="bg-white p-8 rounded-xl shadow-lg border border-slate-100">
            ...
            <p className="text-slate-600 leading-relaxed">
              ...
              most affected by environmental degradation deserve both immediate
          ...
          <div className="bg-white p-8 rounded-xl shadow-lg border border-slate-100">
            ...
            <p className="text-slate-600 leading-relaxed">
              ...
              packages, or poetry that moves hearts. Advocacy without action is
              empty.
            </p>
          </div>
          ...
          <div className="bg-white p-8 rounded-xl shadow-lg border border-slate-100">
            ...
            <p className="text-slate-600 leading-relaxed">
              The most effective interventions come from within communities, not
              imposed from outside. Amplify local voices, support local leaders,
