              ...
              >
                <div className="space-y-8">
                  ...
                  <p className="text-2xl md:text-3xl text-gray-600 leading-relaxed font-light">
                    A global youth leader using poetry, education, and advocacy
                    to inspire change across communities.
                  </p>
                </div>
              </AnimatedContent>
              ...
              >
                <div className="prose prose-xl max-w-none">
                  ...
                  <p className="text-xl leading-relaxed text-gray-700 mb-8">
                    ...
                    and lived experience to create performances that do more
                    than entertain — they inspire, challenge, and ignite change.
                    Having graced over 100 stages, including TEDx LASU, his
                    words have resonated with audiences across academic
                    institutions, government platforms, and global youth spaces.
                  </p>
                  <p className="text-xl leading-relaxed text-gray-700 mb-8">
                    Beyond poetry, MAG is a Global Youth Ambassador with
                    Theirworld, a Youth Delegate to the World Bank Youth Summit,
                    a Microscope Fellowship graduate in youth innovation and
                  ...
                  <p className="text-xl leading-relaxed text-gray-700 mb-8">
                    MAG's leadership extends into governance and student
                    advocacy. He currently serves as the Vice President of the
                    Lagos State University of Education Student Union and the
                    General Secretary of the English Language Student
                    Association of Nigeria (LASU Chapter), where he champions
                    youth participation, leadership, and academic excellence.
                  </p>
                  <p className="text-xl leading-relaxed text-gray-700 mb-8">
                    His contributions to poetry and civic engagement have earned
                    him multiple recognitions, including being a two-time Poet
                    Laureate for Lagos State University, Winner of the Sage
                    Hassan World Poetry Day Slam, and Winner of the Quramo Word
                    Slam 2025. His performances have been recognized by
                    high-profile leaders, including government commissioners and
                  ...
                  <p className="text-xl leading-relaxed text-gray-700">
                    ...
                    remains certain — MAG doesn't just speak; he leaves an
                    imprint on hearts and minds.
                  </p>
                </div>
              </AnimatedContent>
            </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-300 mt-3 leading-relaxed">
                        Representing youth voices on global platforms,
                        advocating for education access and youth empowerment
                        worldwide.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-300 mt-3 leading-relaxed">
                        ...
                        University, celebrating academic excellence through
                        verse.
                      </p>
                    </div>
                  </div>
                ...
                <div className="group">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-300 mt-3 leading-relaxed">
                        First place on World Poetry Day, celebrating the art
                        form with performances that transcend borders.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="group">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-300 mt-3 leading-relaxed">
                        Champion of one of Nigeria's most prestigious spoken
                        word competitions with technical brilliance and
                        emotional depth.
                      </p>
                    </div>
                  </div>
