            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="space-y-8">
                ...
                <p className="text-2xl md:text-3xl text-gray-600 leading-relaxed font-light">
                  Whether you're booking a performance, exploring partnerships, or looking for a speaker—let's start the conversation.
                </p>
                ...
                <div className="space-y-6 pt-8">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a href="mailto:contact@michaelgnaho.com" className="text-xl text-gray-900 hover:text-orange-500 transition-colors">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a href="tel:+234XXXXXXXXXX" className="text-xl text-gray-900 hover:text-orange-500 transition-colors">
                        +234 XXX XXX XXXX
                      </a>
                    </div>
                  </div>
                ...
                {/* Social Media */}
                <div className="pt-8">
                  <p className="text-sm text-gray-500 uppercase tracking-wider mb-4">Connect on Social Media</p>
                  <div className="flex gap-4">
                    <a href="#" className="w-12 h-12 bg-gray-900 hover:bg-orange-500 text-white flex items-center justify-center transition-colors">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <form className="space-y-8">
            <div className="grid md:grid-cols-2 gap-8">
              {/* First Name */}
              <div>
                <label htmlFor="firstName" className="block text-sm font-medium text-gray-700 uppercase tracking-wider mb-3">
                  First Name *
                </label>
                <input
                  type="text"
              ...
              {/* Last Name */}
              <div>
                <label htmlFor="lastName" className="block text-sm font-medium text-gray-700 uppercase tracking-wider mb-3">
                  Last Name *
                </label>
                <input
                  type="text"
            ...
            {/* Email */}
            <div>
              <label htmlFor="email" className="block text-sm font-medium text-gray-700 uppercase tracking-wider mb-3">
                Email Address *
              </label>
              <input
                type="email"
            ...
            {/* Phone */}
            <div>
              <label htmlFor="phone" className="block text-sm font-medium text-gray-700 uppercase tracking-wider mb-3">
                Phone Number
              </label>
              <input
                type="tel"
            ...
            {/* Organization */}
            <div>
              <label htmlFor="organization" className="block text-sm font-medium text-gray-700 uppercase tracking-wider mb-3">
            ...
            {/* Inquiry Type */}
            <div>
              <label htmlFor="inquiryType" className="block text-sm font-medium text-gray-700 uppercase tracking-wider mb-3">
                Type of Inquiry *
              </label>
              <select
                id="inquiryType"
            ...
            {/* Message */}
            <div>
              <label htmlFor="message" className="block text-sm font-medium text-gray-700 uppercase tracking-wider mb-3">
                Message *
              </label>
              <textarea
                id="message"
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-10 shadow-lg hover:shadow-2xl transition-shadow">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Performance Bookings</h3>
              <p className="text-gray-700 leading-relaxed mb-6">
                Poetry performances for conferences, ceremonies, corporate events, and festivals. From intimate gatherings to large-scale productions.
              </p>
            ...
            <div className="bg-white p-10 shadow-lg hover:shadow-2xl transition-shadow">
              ...
              <p className="text-gray-700 leading-relaxed mb-6">
                Keynote speeches and panel discussions on youth leadership, climate action, education advocacy, and creative activism.
              </p>
              <ul className="space-y-2 text-gray-600">
                <li>• Youth summits</li>
            ...
            <div className="bg-white p-10 shadow-lg hover:shadow-2xl transition-shadow">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Advocacy Partnerships</h3>
              <p className="text-gray-700 leading-relaxed mb-6">
                Collaborations on climate action, community development, education access, and social justice initiatives.
              </p>
              <ul className="space-y-2 text-gray-600">
            ...
            <div className="bg-white p-10 shadow-lg hover:shadow-2xl transition-shadow">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Media & Interviews</h3>
              <p className="text-gray-700 leading-relaxed mb-6">
                Available for podcast interviews, magazine features, documentary participation, and media commentary on youth issues.
              </p>
              <ul className="space-y-2 text-gray-600">
            ...
            <div className="bg-white p-10 shadow-lg hover:shadow-2xl transition-shadow">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Workshop Facilitation</h3>
              <p className="text-gray-700 leading-relaxed mb-6">
                Interactive workshops on spoken word poetry, storytelling for advocacy, and using creativity for social change.
              </p>
              <ul className="space-y-2 text-gray-600">
            ...
            <div className="bg-white p-10 shadow-lg hover:shadow-2xl transition-shadow">
              ...
              <p className="text-gray-700 leading-relaxed mb-6">
                Bespoke collaborations combining poetry, technology, and advocacy tailored to your organization's mission.
              </p>
              <ul className="space-y-2 text-gray-600">
      ...
      <section className="relative min-h-[60vh] flex items-center justify-center bg-gray-900 text-white overflow-hidden">
        ...
        <div className="relative z-10 text-center px-6 py-20 max-w-4xl">
          ...
          <p className="text-xl text-gray-300 mb-8">
            I typically respond within 24-48 hours. Let's create something meaningful together.
          </p>
