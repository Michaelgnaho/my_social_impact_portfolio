    ...
    <main className="min-h-screen bg-white">
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="space-y-8">
                ...
                <p className="text-2xl md:text-3xl text-gray-600 leading-relaxed font-light">
                  From government platforms to global youth summits, MAG's performances inspire change across stages worldwide.
                </p>
              </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              <div className="text-5xl md:text-6xl font-bold text-orange-500 mb-4">100+</div>
              <p className="text-xl text-gray-300">Stages Graced</p>
            </div>
            <div className="text-center">
              <div className="text-5xl md:text-6xl font-bold text-orange-500 mb-4">2x</div>
              <p className="text-xl text-gray-300">Poet Laureate</p>
            </div>
            <div className="text-center">
              <div className="text-5xl md:text-6xl font-bold text-orange-500 mb-4">10+</div>
              ...
              <div className="order-2 lg:order-1">
                <div className="space-y-6">
                  <div className="flex items-center gap-3 text-orange-500">
                    ...
                    <span className="text-sm tracking-wider uppercase font-medium">Poet Laureate</span>
                  </div>
                  ...
                  <div className="space-y-2 text-lg text-gray-600">
                    <div className="flex items-center gap-3">
                      ...
                      <span>Lagos State Ministry of Youth and Social Development</span>
                    </div>
                    <div className="flex items-center gap-3">
      ...
      <section className="py-32 px-6 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <div className="mb-20">
            <h2 className="text-5xl md:text-7xl font-bold text-gray-900 mb-6">
              Conference &<br />Summit Performances
            </h2>
            <div className="h-1 w-40 bg-linear-to-r from-orange-500 to-orange-300"></div>
          </div>
              ...
              <div className="order-2 lg:order-1">
                <div className="space-y-6">
                  <div className="flex items-center gap-3 text-orange-500">
                    ...
                    <span className="text-sm tracking-wider uppercase font-medium">Spoken Word Artist</span>
                  </div>
                  <h3 className="text-3xl md:text-4xl font-bold text-gray-900 leading-tight">
                    TEDx LASU
                  </h3>
              ...
              <div>
                <div className="space-y-6">
                  ...
                  <div className="space-y-2 text-lg text-gray-600">
                    <div className="flex items-center gap-3">
                      <MapPin className="w-5 h-5 text-orange-500" />
                      <span>National Youth Council of Nigeria, Lagos State</span>
                    </div>
                    <div className="flex items-center gap-3">
                      <Calendar className="w-5 h-5 text-orange-500" />
                      <span>2023</span>
      ...
      <section className="py-32 px-6 bg-orange-500 text-white">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="space-y-16">
              ...
              <div className="grid lg:grid-cols-2 gap-12 items-center">
                <div className="space-y-6">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-sm tracking-wider uppercase font-bold text-orange-500">WINNER</span>
                  </div>
                ...
                <div className="h-100 bg-linear-to-br from-orange-100 to-orange-50 rounded-sm shadow-xl">
            ...
            <div className="bg-white text-gray-900 p-12 md:p-16 rounded-sm shadow-2xl">
              <div className="grid lg:grid-cols-2 gap-12 items-center">
                <div className="order-2 lg:order-1 h-100 bg-linear-to-br from-orange-100 to-orange-50 rounded-sm shadow-xl">
                  <div className="w-full h-full flex items-center justify-center text-gray-400 border-2 border-dashed border-orange-200">
      ...
      <section className="relative min-h-[80vh] flex items-center justify-center bg-gray-900 text-white overflow-hidden">
        ...
        <div className="relative z-10 text-center px-6 py-20 max-w-5xl">
          <h2 className="text-5xl md:text-7xl lg:text-8xl font-bold mb-8 leading-tight">
            Bring poetry to<br />your platform
          </h2>
          <p className="text-xl md:text-2xl text-gray-300 mb-12 max-w-3xl mx-auto">
            From government ceremonies to corporate events, conferences to festivals — MAG delivers performances that transform moments into movements.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
            ...
            >
              ...
              <span className="absolute inset-0 flex items-center justify-center text-gray-900 opacity-0 group-hover:opacity-100 transition-opacity z-20">Learn More</span>
            </a>
          </div>
        </div>
      </section>
