            ...
            >
              <div className="space-y-5 mb-12">
                <p className="text-lg text-neutral-700 leading-relaxed">
                  I am a spoken word poet and Global Youth Ambassador at
                  Theirworld, using the transformative power of words to
                  challenge systems and amplify the voices of young people
                  worldwide.
                </p>

                <p className="text-lg text-neutral-700 leading-relaxed">
                  Through poetry, keynote speeches, and grassroots organizing, I
                  advocate for education equity, climate justice, and youth
                  empowerment—bridging art and activism to create meaningful
                  change.
                </p>
              </div>
            </AnimatedContent>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-neutral-600">
                      Fighting for universal access to quality education and
                      breaking barriers to learning worldwide.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-neutral-600">
                      Demanding urgent climate action and environmental justice
